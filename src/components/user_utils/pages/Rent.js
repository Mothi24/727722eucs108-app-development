...
import { RentContext } from '../../contexts/ClothData'
...
const Rent = () => {
  ...
  const { rentData } = useContext(RentContext);
      ...
      <ContentContainer component="main">
        ...
        <Box>
          ...
          <div ref={shirtRef}>
            ...
            <ShopItemCard items={rentData.ShirtList} />
          </div>
          ...
          <div ref={pantRef}>
            ...
            <ShopItemCard items={rentData.PantList} />
          </div>
          ...
          <div ref={tshirtRef}>
            ...
            <ShopItemCard items={rentData.TshirtList} />
          </div>
          ...
          <div ref={trousersRef}>
            ...
            <ShopItemCard items={rentData.TrousersList} />
          </div>
          ...
          <div ref={suiteRef}>
            ...
            <ShopItemCard items={rentData.SuitList} />
          </div>
        </Box>
      </ContentContainer>
