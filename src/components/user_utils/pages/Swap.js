...
import { SwapContext } from '../../contexts/ClothData';
      ...
      <ContentContainer component="main">
        ...
        <Box>
          ...
          <div ref={shirtRef}>
            ...
            <ShopItemCard items={swapData.ShirtList} />
          </div>
          ...
          <div ref={pantRef}>
            ...
            <ShopItemCard items={swapData.PantList} />
          </div>
          ...
          <div ref={tshirtRef}>
            ...
            <ShopItemCard items={swapData.TshirtList} />
          </div>
          ...
          <div ref={trousersRef}>
            ...
            <ShopItemCard items={swapData.TrousersList} />
          </div>
          ...
          <div ref={suiteRef}>
            ...
            <ShopItemCard items={swapData.SuitList} />
          </div>
        </Box>
      </ContentContainer>
